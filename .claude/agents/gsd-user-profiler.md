...
<reference>
@C:/Users/Jayanth K/Desktop/medibuddy/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/Jayanth K/Desktop/medibuddy/.claude/gsd-core/references/user-profiling.md` to load:
