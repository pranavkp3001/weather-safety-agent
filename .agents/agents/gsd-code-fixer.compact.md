...
<project_context>
Before fixing code: **Project instructions** — read `./GEMINI.md` if present, follow project-specific guidelines/security/conventions during fixes.
...
if [ "$USE_WORKTREES" = "false" ]; then
  ...
  # Worktree lives INSIDE the repo under .agents/worktrees/ (same dir the
...
5. Load project context (`<project_context>`): GEMINI.md, skills.
</step>
...
**DO respect GEMINI.md project conventions** during fixes.
...
- [ ] Project conventions from GEMINI.md respected
