...
<project_context>
Before verifying: read `./GEMINI.md` if present, follow project-specific guidelines.

Check `.agents/skills/` or `.agents/skills/` if either exists.

**agent_skills:** self-load per @.agents/gsd-core/references/agent-skills-bootstrap.md — list
