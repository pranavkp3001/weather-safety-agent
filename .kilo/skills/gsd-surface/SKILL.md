...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/Jayanth K/Desktop/medibuddy/.kilo/.gsd-surface.json`
(sibling to `C:/Users/Jayanth K/Desktop/medibuddy/.kilo/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/Jayanth K/Desktop/medibuddy/.kilo/skills/gsd-*/`.
...
(`~/.config/kilo`), NOT the skills sub-directory (`C:/Users/Jayanth K/Desktop/medibuddy/.kilo/skills`).
...
`C:/Users/Jayanth K/Desktop/medibuddy/.kilo/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/Jayanth K/Desktop/medibuddy/.kilo/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/Jayanth K/Desktop/medibuddy/.kilo/.gsd-surface.json`
Install profile marker: `C:/Users/Jayanth K/Desktop/medibuddy/.kilo/.gsd-profile`
Skill dirs: `C:/Users/Jayanth K/Desktop/medibuddy/.kilo/skills/gsd-*/`
Engine module: `C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/bin/lib/clusters.cjs`
</execution_context>
