...
Check `.kilo/skills/` or `.kilo/skills/` if either exists.

**agent_skills:** self-load per @C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/references/agent-skills-bootstrap.md — list
