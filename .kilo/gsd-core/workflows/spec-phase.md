...
ones). Reference: @C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/Users/Jayanth K/Desktop/medibuddy/.kilo.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/Users/Jayanth K/Desktop/medibuddy/.kilo/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/templates/spec.md.
