...
<required_reading>
@C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/references/ai-frameworks.md
@C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Users/Jayanth K/Desktop/medibuddy/.kilo/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Users/Jayanth K/Desktop/medibuddy/.kilo/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Users/Jayanth K/Desktop/medibuddy/.kilo/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Users/Jayanth K/Desktop/medibuddy/.kilo/agents/gsd-eval-planner.md for instructions.
