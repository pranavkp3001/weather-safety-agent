...
Read and follow `C:/Users/Jayanth K/Desktop/medibuddy/.kilo/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
