...
```
Agent(
  prompt="Read C:/Users/Jayanth K/Desktop/medibuddy/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Jayanth K/Desktop/medibuddy/.opencode/gsd-core/templates/SECURITY.md`
