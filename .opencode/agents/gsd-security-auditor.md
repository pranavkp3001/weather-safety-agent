...
**Verification depth scales with `asvs_level`** (see @C:/Users/Jayanth K/Desktop/medibuddy/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
