...
**Verification depth scales with `asvs_level`** (full definitions: @C:/Users/Jayanth K/Desktop/medibuddy/.opencode/gsd-core/references/security-asvs-levels.md):
