...
```
Full template: `C:/Users/Jayanth K/Desktop/medibuddy/.opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure
Use template from `C:/Users/Jayanth K/Desktop/medibuddy/.opencode/gsd-core/templates/state.md`. Key sections: Project Reference, Current Position, Performance Metrics, Accumulated Context (decisions, todos, blockers), Session Continuity.
